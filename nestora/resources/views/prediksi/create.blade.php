                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6"> {{-- Contoh: Tambah lg:grid-cols-3 --}}
                            ...
                            <div>
                                ...
                                <select id="verified" name="verified" required
                                    ...
                                    <option value="0" {{ old('verified') == '0' ? 'selected' : '' }}>Tidak Terverifikasi</option>
                                    <option value="1" {{ old('verified') == '1' ? 'selected' : '' }}>Terverifikasi</option>
                                </select>
                            ...
                            {{-- Input SizeMin --}}
                            <div>
                                <x-input-label for="sizeMin" :value="__('Ukuran Minimal (sqft)')" class="mb-1" />
                            ...
                            <div>
                                ...
                                <select id="view_type" name="view_type" required
                                    ...
                                    <option value="1" {{ old('view_type') == '1' ? 'selected' : '' }}>Pemandangan Laut</option>
                                    <option value="2" {{ old('view_type') == '2' ? 'selected' : '' }}>Pemandangan Burj Khalifa</option>
                                    <option value="3" {{ old('view_type') == '3' ? 'selected' : '' }}>Pemandangan Lapangan Golf</option>
                                    <option value="4" {{ old('view_type') == '4' ? 'selected' : '' }}>Pemandangan Komunitas</option>
                                    <option value="5" {{ old('view_type') == '5' ? 'selected' : '' }}>Pemandangan Kota</option>
                                    <option value="6" {{ old('view_type') == '6' ? 'selected' : '' }}>Pemandangan Danau</option>
                                    <option value="7" {{ old('view_type') == '7' ? 'selected' : '' }}>Pemandangan Kolam Renang</option>
                                    <option value="8" {{ old('view_type') == '8' ? 'selected' : '' }}>Pemandangan Kanal</option>
                                    <option value="0" {{ old('view_type') == '0' ? 'selected' : '' }}>Lainnya / Tidak Ada</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="title_keyword" name="title_keyword" required
                                    ...
                                    <option value="0" {{ old('title_keyword') == '0' ? 'selected' : '' }}>Tidak Ada Keyword Spesifik</option>
                                    <option value="1" {{ old('title_keyword') == '1' ? 'selected' : '' }}>Mewah (Luxury)</option>
                                    <option value="2" {{ old('title_keyword') == '2' ? 'selected' : '' }}>Berperabot (Furnished)</option>
                                    <option value="3" {{ old('title_keyword') == '3' ? 'selected' : '' }}>Luas (Spacious)</option>
                                    <option value="4" {{ old('title_keyword') == '4' ? 'selected' : '' }}>Utama (Prime)</option>
                                    <option value="5" {{ old('title_keyword') == '5' ? 'selected' : '' }}>Studio</option>
                                    <option value="6" {{ old('title_keyword') == '6' ? 'selected' : '' }}>Penthouse</option>
                                    <option value="7" {{ old('title_keyword') == '7' ? 'selected' : '' }}>Investasi (Investment)</option>
                                    <option value="8" {{ old('title_keyword') == '8' ? 'selected' : '' }}>Villa</option>
                                    <option value="9" {{ old('title_keyword') == '9' ? 'selected' : '' }}>Pusat Kota (Downtown)</option>
                                </select>
